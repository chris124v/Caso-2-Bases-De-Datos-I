...
GO
CREATE OR ALTER PROCEDURE [dbo].[SPDirtyReadUncommitted1]
AS 
BEGIN
	SET NOCOUNT ON
...
GO
CREATE OR ALTER PROCEDURE [dbo].[SPIncorrectSummaryUncommitted1]
AS 
BEGIN
...
GO
CREATE OR ALTER PROCEDURE [dbo].[SPLostUpdateUncommitted1]
AS 
BEGIN
...
/*
EXEC dbo.SPDirtyReadUncommitted1
EXEC dbo.SPIncorrectSummaryUncommitted1
*/
